...
public class BlackJackUnitTest {
	...
	/********************************************************
	 * Test case for hasAce method, seeing if when given a 
	 * hand containing an ACE, if it returns true.
	 ********************************************************/
	@Test
	public void AceTest(){
		Game game = new Game();
	...
	/********************************************************
	 * Test case for hasAce method, seeing if when a hand 
	 * DOES NOT have an ACE, if it returns false.
	 ********************************************************/
	@Test
	...
	/********************************************************
	 * Test case for dealerHit method, seeing if when the 
	 * dealer's hand is less than 17, if it will obtain 
	 * another card
	 ********************************************************/
	@Test
	...
	/********************************************************
	 * Test case for dealerHit method, seeing if when the 
	 * dealer's hand is >= 17, if it will NOT obtain another 
	 * card
	 ********************************************************/
	@Test
